<template>
<div class="adminNav">
    <router-link :to="{ name: 'Home' }"><h1 class="title pl-5 pt-5">Lifelong Learning<br>@ EEE</h1></router-link>
    ...
    <aside class="menu">
        ...
        <ul class="menu-list">
            ...
            <li><router-link class="router" active-class="active" :to="{ name: 'Admin Past Workshop' }">View Past Workshops</router-link></li>
        </ul>
